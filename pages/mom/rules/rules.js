...
Page({
  ...
  rulesData: [
      ...
      { section: 'section - income', sectionName: '分享津贴规则', keywords: '津贴 计算 奖励 比例 发放 结算 额外 加成 退款 取消', content: '津贴计算: 分享津贴等于订单实付金额乘以分享奖励比例。基础佣金10%（爆款商品），优质妈妈20%（高端/定制款）。奖励发放: 好友确认收货后7个工作日内结算。特殊情况: 退款或取消订单不予结算。' },
