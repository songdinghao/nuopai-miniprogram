...
Page({
  ...
  faqData: [
    ...
    items: [
      ...
      answer: '收益来源：生成专属素材→分享给好友→好友通过您的链接下单→订单完成后获得佣金。基础佣金10%（爆款商品），优质妈妈20%（高端/定制款）。具体比例在商品分享页面有标注。',
      expanded: false
          },
          {
      id: 'm3',
      ...
      id: 'm5',
      question: '邀请好友有奖励吗？',
      answer: '有奖励！邀请好友成为兼职妈妈体验官，好友完成首单后，您将获得额外28元友伴首单奖励；②您自己的订单佣金正常计算；③被邀请人体验官等级提升时，邀请人可获得等级提升奖励。',
      expanded: false
          },
          {
      id: 'm6',
      ...
      answer: '等级提升条件：新手妈妈→银牌妈妈：累计10单；银牌→金牌：累计50单；金牌→钻石：累计200单；钻石→皇冠：累计500单。等级特权：①佣金比例加成（银牌+2%，金牌+5%，钻石+10%，皇冠+15%）；②专属素材模板；③优先客服通道；④等级徽章展示。',
      expanded: false
          },
          {
      id: 'm8',
    ...
    items: [
      ...
      id: 'i4',
      question: '奖励比例是多少？',
      answer: '分享奖励比例：基础佣金10%（爆款商品），优质妈妈20%（高端/定制款）。具体比例在商品分享页面有标注，您可在分享前查看。',
      expanded: false
          }
    ]
      },
